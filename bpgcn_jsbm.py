...
from opt_jsbm_net import Bpnet
...
def main():
    ...
    onehot_label=torch.zeros(args.nu, args.Q).scatter_(1, labels.view(args.nu,1).cpu(), 1)
   ...
   # print(randomindex)
    ...
    C,W=initCW(args.x,args.y,args.Q,args.c1,args.c2)
